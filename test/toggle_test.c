...
//添加文本空间
   ...
   GtkWidget *button2=gtk_radio_button_new_with_mnemonic(NULL,"测试3");
   gtk_widget_show(button2);

   GSList *group=gtk_radio_button_group(GTK_RADIO_BUTTON(button2));
   ...
   GtkWidget *button3=gtk_check_button_new_with_mnemonic("测试3");
